...
public:
    ...
    bool readuntil(uICAL::string& st, char delim) override {
...
// with looping to handle lines longer than buffer
...
public:
    ...
    // Simulate the FIXED Arduino behavior: loop until delimiter
    bool readuntil(uICAL::string& st, char delim) override {
        ...
        while (true) {
            ...
            buf[i] = 0;
            st += buf;
            // Buffer was full, continue reading
        }
    }
